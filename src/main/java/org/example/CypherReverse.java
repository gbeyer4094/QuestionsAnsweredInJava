...
public class CypherReverse {
    public static String reverseLetterCypher(String message) {
        // Define the normal and reversed alphabets
        String normalAlphabet = "abcdefghijklmnopqrstuvwxyz";
        String reversedAlphabet = new StringBuilder(normalAlphabet).reverse().toString();
    ...
    public static void main(String[] args) {
        ...
        String encryptedMessage = reverseLetterCypher(message);
